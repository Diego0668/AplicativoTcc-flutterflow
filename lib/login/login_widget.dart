        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFFE4DAFF), Color(0xFF76B2E8), Colors.white],
              stops: [0.0, 1.0, 1.0],
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Meu_projeto_(1).png',
                        width: 300.0,
                        height: 200.0,
                ...
                Align(
                  alignment: AlignmentDirectional(-0.05, -0.30),
                  child: Padding(
                    padding:
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 12.0, 0.0, 24.0),
                                child: Text(
                                  'Use sua conta para realizar o login',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
